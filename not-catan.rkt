...
(define (valid-inventory? value)
  (and (inventory? value)
       (integer? (inventory-blocks value)) (>= (inventory-blocks value) 0)
       (integer? (inventory-wood value)) (>= (inventory-wood value) 0)
       (integer? (inventory-sheep value)) (>= (inventory-sheep value) 0)
       (integer? (inventory-wheat value)) (>= (inventory-wheat value) 0)
       (integer? (inventory-rocks value)) (>= (inventory-rocks value) 0)
...
(check-expect (affordable? (make-inventory 1 3 9 7 7)
                           (make-cost 2 4 5 9 9)) false)
;; no units cost too much but wheat is not >= sheep
(check-expect (affordable? (make-inventory 3 5 9 9 9)
                           (make-cost 2 4 5 9 9)) false)
(check-expect (affordable? (make-inventory 5 7 9 13 9)
                           (make-cost 2 4 5 9 9)) false)
;; no units cost too much, wheat is >= sheep but wheat is not
;;      >= 4
(check-expect (affordable? (make-inventory 3 5 8 12 9)
                           (make-cost 2 4 5 9 9)) false)
(check-expect (affordable? (make-inventory 5 7 6 10 9)
                           (make-cost 2 4 5 9 9)) false)
;; no units cost too much and wheat >= sheep and wheat >= 4
(check-expect (affordable? (make-inventory 7 7 9 17 12)
                           (make-cost 2 4 5 9 9)) true)
(check-expect (affordable? (make-inventory 7 7 11 16 12)
                           (make-cost 2 4 5 9 9)) true)
